 ...
 * $chat_me_now__options = get_option( 'chat_me_now__option_name' ); // Array of All Options
 * $whatsapp1 = $chat_me_now__options['whatsapp1']; // whatsapp1
 * $whatsapp2 = $chat_me_now__options['whatsapp2']; // whatsapp2
 * $whatsapp_active_turn = $chat_me_now__options['whatsapp_active_turn']; // whatsapp-active-turn
 * $background_color = $chat_me_now__options['background_color']; // background-color
 * $schedule_turn = $chat_me_now__options['schedule_turn']; // schedule-turn
 * $active = $chat_me_now__options['active']; // active
 */